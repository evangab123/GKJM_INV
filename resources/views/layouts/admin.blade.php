...
<head>
    ...
    <meta name="description" content="Inventaris GKJ Mergangsan">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
                <div class="sidebar-brand-icon rotate-n-15">
                    <i>
                        <img src={{ asset('img/icongkj.png') }} width="50px">
                    </i>
                </div>
                <div class="sidebar-brand-text mx-3">GKJM Inventaris</div>
            </a>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseData" class="collapse" aria-labelledby="headingData"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item {{ Nav::isRoute('kategori.index') }}" href="{{ route('kategori.index') }}">
                                <i class="fas fa-tags"></i> {{ __('Kategori') }}
                            </a>
                            <a class="collapse-item {{ Nav::isRoute('ruang.index') }}" href="{{ route('ruang.index') }}">
                                <i class="fas fa-door-open"></i> {{ __('Ruangan') }}
                            </a>
                        </div>
                    </div>
                </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Page Heading -->
                    <h1 class="font-weight-bold">@yield('title', 'Default Title')</h1>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span
                                    class="mr-2 d-none d-lg-inline text-gray-600 small">{{ Auth::user()->name_pengguna }}</span>
                                <figure class="img-profile rounded-circle avatar font-weight-bold"
                                    data-initial="{{ Auth::user()->name_pengguna }}"></figure>
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Evander Gabriel 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
